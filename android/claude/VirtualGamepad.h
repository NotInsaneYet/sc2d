...
public:
    ...
    // Call from main loop — returns true if a rumble command was received.
    // strong/weak are 0..65535. Call SteamController::SendHaptic() with them.
...
private:
    ...
    int32_t m_prevLX{}, m_prevLY{};
    int32_t m_prevRX{}, m_prevRY{};
